          ...
          <div class="content-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body">
                        <div><h4 class="card-title">Agriculteurs</h4>
                        ...
                        <table class="table table-bordered">
                          <thead style="color: green">
                            <tr>
                              ...
                              <th> Ville/région </th>
                              <th> Birthday </th>
                              <th style="width: 8%; align:center"> Notification</th>
                            </tr>
                          </thead>
                          <tbody id="myTable">
                              ...
                              <td>
                                <button  class="button4" data-toggle="modal" data-target="#exampleModal1{{ $i }}" style=" align:center" >
                                  Envoyer</button>
