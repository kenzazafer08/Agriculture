...
@php($p=$item->cin)
			...
			<div class="card-body text-center bg-primary rounded-top">
			   ...
			   <h5 class="mb-1 text-black">{{ $item->prenom }} {{ $item->nom }}</h5>
			  </div>
								...
								<div class="card-body" style="padding-top: 0px;padding-bottom: 0px;">
									<ul class="list-group shadow-none">
										...
										<li class="list-group-item">
										  <div class="list-icon">
											<i class="fa fa-phone" style="margin-right:10px;"></i>0{{ $item->tel }}
										  </div>
										</li>
										<li class="list-group-item" style="width:auto;">
											<div class="list-icon">
											  <i class="fa fa-map-marker" style="margin-right:10px;"></i>{{ $item->ville }}, {{ $item->region }}
											</div>
										  </li>
										</ul>
				...
				<div class="col-12 col-lg-7 col-xl-9" >
					<div class="tab-content p-3">
                        <div class="tab-pane active show" id="chat{{ $p }}">
...
@if(($m->investisseur2==$p or $m->investisseur1==$p) )
	@if($m->investisseur2!=$p)

							<div class="chat-message-right pb-4"  style="display: flex;
							flex-shrink: 0;
							flex-direction: row-reverse;margin-left: auto;">
								
								<div class="flex-shrink-1 rounded py-2 px-3 mr-3" style="background-color:#d8d8d8;">{{ $m->msg }}
									
								</div><br/>
								
							</div>
						@else
							<div class="chat-message-left pb-4" style="display:flex; margin-right: auto;display: flex;
							flex-shrink: 0;
							">
